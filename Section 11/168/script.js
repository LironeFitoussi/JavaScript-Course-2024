...
// 4.
const ownersEatOkay = dogs.filter(dog => dog.curFood < dog.recommendedFood).flatMap(dog => dog.owners);
console.log(`${ownersEatTooMuch.join(' and ')}s dogs eat too much!`);
console.log(`${ownersEatOkay.join(' and ')}s eat too little!`);
...
const sortedDogs = dogs.slice().sort(
  ({ recommendedFood: rec1 }, { recommendedFood: rec2 }) =>
    rec1 - rec2
)
